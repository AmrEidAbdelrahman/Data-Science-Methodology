...
Your Answer: 
We need to understand the question and what is the problem that we are trying to solve. Then we can go further to Analythical approach to determine how can we use data to solve the question. If we in the beginning do not understand the real problem and question of the business owner than we can not find out the right solutions.
It helps calarify the goal of the entity asking the question.
...
Your Answer:No. we will need more data.
...
Your Answer:maybe, potentially yes as there are specific ingredients unique to each cuisine
...
Your Answer:Identify what type of patterns will be needed to address the question most effectively
